...
EX_LANGUAGES = (
    'ben', 'cat', 'ces', 'dan', 'ell', 'fin', 'fra', 'hrv', 'hun', 'ind',
    'ita', 'lit', 'lav', 'nob', 'plk', 'ron', 'slk', 'slv', 'srp', 'swe',
    'tam', 'trk'
)

XE_LANGUAGES = (
    'bul', 'cat', 'ces', 'dan', 'ell', 'est', 'hin', 'hrv', 'hun', 'lit',
    'lav', 'nob', 'plk', 'ron', 'slk', 'slv', 'tha', 'trk'
)
...
class Command(BaseCommand):
    help = 'Initialises campaign FY19 #62'
