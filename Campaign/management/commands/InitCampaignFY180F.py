...
EX_LANGUAGES = (
  'rus', 'por', 'fra', 'spa', 'ita', 'tha', 'ben'
)

XE_LANGUAGES = (
  'rus', 'por', 'fra', 'spa', 'ita', 'tha', 'ben', 'zho'
)

XY_LANGUAGES = (
)

CAMPAIGN_NAME = 'AppenEvalFY180F'
CAMPAIGN_KEY = 'FY180F'
CAMPAIGN_NO = 15
ANNOTATORS = 5
TASKS = 10
...
class Command(BaseCommand):
    help = 'Initialises campaign FY18 #15'
    ...
    def handle(self, *args, **options):
        ...
        for key in tasks_for_market:
            ...
            # _tasks has size 20 due to duplicating tasks above
            # _users has size 5, so we need 4 copies to match
            _tasks = tasks_for_market[key]
            _users = users_for_market[key] * 4
