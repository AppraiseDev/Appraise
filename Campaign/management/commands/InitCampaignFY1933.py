...
XE_LANGUAGES = (
    'ara', 'deu', 'fra', 'jpn', 'rus', 'zho',
)

XY_LANGUAGES = (
)

CAMPAIGN_NAME = 'HumanEvalFY1933'
CAMPAIGN_KEY = 'FY1933'
CAMPAIGN_NO = 139
ANNOTATORS = 3
TASKS = 6
...
class Command(BaseCommand):
    help = 'Initialises campaign FY19 #51'
    ...
    def handle(self, *args, **options):
        ...
        for key in tasks_for_market:
            ...
            # _tasks has size 6 due to not duplicating tasks above
            # _users has size 3, so we need 2 copies to match
