...
EX_LANGUAGES = (
  'ara', 'spa', 'por', 'zho', 'deu', 'fra',
  'jpn', 'kor', 'rus', 'nld', 'ita', 'swe',
  'ell', 'hun', 'trk', 'ces', 'slk', 'slv',
  'bgr', 'ukr', 'fin', 'dan', 'ron', 'heb',
  'nob', 'cym', 'plk', 'ind', 'vie', 'tha',
  'hin', 'urd', 'tam',
)
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for key in tasks_for_market:
            ...
            # _tasks has size 12 due to duplicating tasks above
            # _users has size 6, so we need 2 copies to match
