...
EX_LANGUAGES = (
    'ces', 'dan', 'hin', 'hun', 'ind', 'nld', 'plk', 'swe', 'tha', 'trk',
)
...
EX_TASKS = {
    'ces': 32, 'dan': 20, 'hin':  8, 'hun': 24, 'ind':  6,
    'nld': 28, 'plk': 24, 'swe': 20, 'tha': 10, 'trk': 20,
}
...
class Command(BaseCommand):
    help = 'Initialises campaign FY19 #66'
