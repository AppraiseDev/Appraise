...
EX_LANGUAGES = (
  'ben', 'bul', 'cym', 'dan', 'deu', 'ell', 'est', 'fra', 'heb', 'hin',
  'hun', 'ita', 'jpn', 'kor', 'lav', 'nld', 'nob', 'plk', 'por', 'ron',
  'rus', 'slk', 'slv', 'spa', 'swe', 'tha', 'ukr', 'zho'
)
...
class Command(BaseCommand):
    help = 'Initialises campaign FY18 #21'
