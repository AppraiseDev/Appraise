...
EX_LANGUAGES = (
    ...
    'ita', 'lit', 'lav', 'nob', 'plk', 'ron', 'slk', 'slv', 'swe', 'tam',
    'trk'
)

XE_LANGUAGES = (
    'bul', 'ben', 'cat', 'ces', 'cym', 'dan', 'ell', 'est', 'heb', 'hin',
    'hrv', 'hun', 'ind', 'isl', 'lit', 'lav', 'nob', 'plk', 'ron', 'slk',
    'slv', 'swe', 'tha', 'trk'
)
...
class Command(BaseCommand):
    help = 'Initialises campaign FY19 #59'
