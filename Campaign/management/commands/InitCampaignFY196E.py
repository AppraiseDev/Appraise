...
TASKS_TO_ANNOTATORS = {
    ('eng', 'jpn') : _create_uniform_task_map(11, 22, REDUNDANCY),
    ('eng', 'por') : _create_uniform_task_map(11, 22, REDUNDANCY),
    ('eng', 'rus') : _create_uniform_task_map(21, 42, REDUNDANCY),
    ('eng', 'zho') : _create_uniform_task_map(10, 20, REDUNDANCY),
}
...
class Command(BaseCommand):
    help = 'Initialises campaign FY19 #109'
