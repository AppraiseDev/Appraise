...
class Command(BaseCommand):
    help = 'Initialises campaign FY18 #18'
    ...
    def handle(self, *args, **options):
        ...
        for key in tasks_for_market:
            ...
            # _tasks has size 24 due to duplicating tasks above
            # _users has size 6, so we need 4 copies to match
