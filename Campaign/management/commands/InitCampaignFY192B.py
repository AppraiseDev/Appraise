...
class Command(BaseCommand):
    help = 'Initialises campaign FY19 #43'
    ...
    def handle(self, *args, **options):
        ...
        for key in tasks_for_market:
            ...
            # _tasks has size 42 due to duplicating tasks above
            # _users has size 21, so we need 2 copies to match
