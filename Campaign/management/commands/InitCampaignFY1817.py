...
class Command(BaseCommand):
    help = 'Initialises campaign FY18 #23'
    ...
    def handle(self, *args, **options):
        ...
        for key in tasks_for_market:
            ...
            # _tasks has size 64 due to duplicating tasks above
            # _users has size 16, so we need 4 copies to match
