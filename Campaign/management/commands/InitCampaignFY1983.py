...
EX_LANGUAGES = (
    'ces', 'deu', 'fin', 'guj', 'kaz', 'lit', 'rus', 'zho',
)

XE_LANGUAGES = (
    'deu', 'fin', 'guj', 'kaz', 'lit', 'rus', 'zho',
)

XY_LANGUAGES = (
    ('deu', 'ces'), ('deu', 'fra'), ('fra', 'deu')
)
...
TASKS_TO_ANNOTATORS = {
    ...
    ('deu', 'eng') : _create_uniform_task_map(24, 48, REDUNDANCY),
    ('deu', 'fra') : _create_uniform_task_map(10, 20, REDUNDANCY),
    ('eng', 'ces') : _create_uniform_task_map(12, 24, REDUNDANCY),
    ('eng', 'deu') : _create_uniform_task_map(24, 48, REDUNDANCY),
    ('eng', 'fin') : _create_uniform_task_map(12, 24, REDUNDANCY),
    ('eng', 'guj') : _create_uniform_task_map( 6, 12, REDUNDANCY),
    ('eng', 'kaz') : _create_uniform_task_map( 6, 12, REDUNDANCY),
    ('eng', 'lit') : _create_uniform_task_map( 6, 12, REDUNDANCY),
    ('eng', 'rus') : _create_uniform_task_map(12, 24, REDUNDANCY),
    ('eng', 'zho') : _create_uniform_task_map(12, 24, REDUNDANCY),
    ('fin', 'eng') : _create_uniform_task_map(12, 24, REDUNDANCY),
    ('fra', 'deu') : _create_uniform_task_map(10, 20, REDUNDANCY),
    ('guj', 'eng') : _create_uniform_task_map( 6, 12, REDUNDANCY),
    ('kaz', 'eng') : _create_uniform_task_map( 6, 12, REDUNDANCY),
    ('lit', 'eng') : _create_uniform_task_map( 6, 12, REDUNDANCY),
    ('rus', 'eng') : _create_uniform_task_map(12, 24, REDUNDANCY),
    ('zho', 'eng') : _create_uniform_task_map(12, 24, REDUNDANCY),
}
...
class Command(BaseCommand):
    help = 'Initialises campaign FY19 #131'
