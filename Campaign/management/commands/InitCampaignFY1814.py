...
EX_LANGUAGES = (
  'ben', 'bul', 'dan', 'deu', 'ell', 'est', 'fra', 'heb', 'hin', 'hun',
  'ita', 'kor', 'nld', 'nob', 'por', 'ron', 'rus', 'slk', 'slv', 'swe',
  'tha', 'zho'
)

XE_LANGUAGES = (
  'ben', 'bul', 'dan', 'ell', 'est', 'fra', 'heb', 'hin', 'hun', 'jpn',
  'nob', 'plk', 'ron', 'slk', 'slv', 'spa', 'swe', 'tha', 'zho'  
)

XY_LANGUAGES = (
)

CAMPAIGN_NAME = 'AppenEvalFY1814'
CAMPAIGN_KEY = 'FY1814'
CAMPAIGN_NO = 20
ANNOTATORS = 5
TASKS = 5
...
class Command(BaseCommand):
    help = 'Initialises campaign FY18 #20'
    ...
    def handle(self, *args, **options):
        ...
        for key in tasks_for_market:
            ...
            # _tasks has size 10 due to duplicating tasks above
            # _users has size 5, so we need 2 copies to match
