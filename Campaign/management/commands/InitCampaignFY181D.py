...
EX_LANGUAGES = (
  'bul', 'ben', 'zho', 'dan', 'ell', 'est', 'fra', 'hin', 'ita', 'kor',
  'nob', 'por', 'rus', 'slk', 'swe', 'tha'
)

XE_LANGUAGES = (
  'bul', 'zho', 'dan', 'ell', 'est', 'fra', 'hun', 'jpn', 'nob', 'plk',
  'ron', 'slk', 'slv', 'spa', 'swe', 'tha'
)

XY_LANGUAGES = (
)

CAMPAIGN_NAME = 'AppenEvalFY181D'
CAMPAIGN_KEY = 'FY181D'
CAMPAIGN_NO = 29
ANNOTATORS = 5
TASKS = 5
...
class Command(BaseCommand):
    help = 'Initialises campaign FY18 #29'
