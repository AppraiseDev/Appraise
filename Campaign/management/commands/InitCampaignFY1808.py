...
class Command(BaseCommand):
    help = 'Initialises campaign FY18 #8'
    ...
    def handle(self, *args, **options):
        ...
        for key in tasks_for_market:
            ...
            # _tasks has size 2*n due to duplicating tasks above
            # _users has size n/2, so we need 4 copies to match
