...
class Command(BaseCommand):
    help = 'Initialises campaign FY18 #9'
    ...
    def handle(self, *args, **options):
        ...
        # T10  U1 U2 ... U6
        #
        # To assign this, we need to duplicate tasks 6 times.
        ...
        for key in tasks_for_market:
            ...
            # _tasks has size 60 due to duplicating tasks above
            # _users has size 6, so we need 10 copies to match
            _tasks = tasks_for_market[key]
            _users = users_for_market[key] * 10
