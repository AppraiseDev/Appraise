...
CAMPAIGN_NAME = 'WMT19DocSrcDA'
CAMPAIGN_KEY = 'WMT19DocSrcDA'
CAMPAIGN_NO = 228
...
TASKS_TO_ANNOTATORS = {
    ('eng', 'ces') : _create_uniform_task_map(100, 200, REDUNDANCY),
    ('eng', 'deu') : _create_uniform_task_map(50, 100, REDUNDANCY),
    ('eng', 'fin') : _create_uniform_task_map(50, 100, REDUNDANCY),
    ('eng', 'kaz') : _create_uniform_task_map(50, 100, REDUNDANCY),
    ('eng', 'lit') : _create_uniform_task_map(50, 100, REDUNDANCY),
    ('eng', 'rus') : _create_uniform_task_map(50, 100, REDUNDANCY),
    ('eng', 'zho') : _create_uniform_task_map(50, 100, REDUNDANCY),
}
