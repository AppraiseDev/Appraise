...
XE_LANGUAGES = (
  'ara', 'spa', 'por', 'zho', 'deu', 'fra', 'jpn', 'kor'
)

XY_LANGUAGES = (
)

CAMPAIGN_NAME = 'AppenEvalFY1837'
CAMPAIGN_KEY = 'FY1837'
CAMPAIGN_NO = 55
ANNOTATORS = 8
TASKS = 16
...
class Command(BaseCommand):
    help = 'Initialises campaign FY18 #55'
    ...
    def handle(self, *args, **options):
        ...
        for key in tasks_for_market:
            ...
            # _tasks has size 16 due to duplicating tasks above
            # _users has size 8, so we need 2 copies to match
