...
EX_LANGUAGES = (
    'bgr', 'ben', 'est', 'fra', 'lit', 'lav', 'spa'
)

XE_LANGUAGES = (
    'acm', 'ayl', 'ayn', 'bgr', 'ben', 'cat', 'ell', 'est', 'jpn', 'lav'
)

XY_LANGUAGES = (
)

CAMPAIGN_NAME = 'HumanEvalFY1931'
CAMPAIGN_KEY = 'FY1931'
CAMPAIGN_NO = 137
ANNOTATORS = 5
TASKS = 5
...
class Command(BaseCommand):
    help = 'Initialises campaign FY19 #49'
    ...
    def handle(self, *args, **options):
        ...
        for key in tasks_for_market:
            ...
            # _users has size 10, so we need 2 copies to match
