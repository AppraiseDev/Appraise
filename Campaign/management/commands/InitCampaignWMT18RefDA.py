...
EX_LANGUAGES = ('ces', 'deu', 'est', 'fin', 'rus', 'trk', 'zho')

XE_LANGUAGES = ('ces', 'deu', 'est', 'fin', 'rus', 'trk', 'zho')

XY_LANGUAGES = ()

CAMPAIGN_NAME = 'WMT18RefDA'
CAMPAIGN_KEY = 'WMT18RefDA'
CAMPAIGN_NO = 80
ANNOTATORS = 50
TASKS = 100
REDUNDANCY = 1
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for key in tasks_for_market:
            ...
            # _tasks has size 100 due to duplicating tasks above
            # _users has size 50, so we need 2 copies to match
