# Generated by Django 4.2.22 on 2026-04-11 23:00
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('EvalData', '0060_pairwiseassessmentdocumentresult_comment'),
    ]

    operations = [
        migrations.CreateModel(
            name='TextSegmentWithThreeTargetsWithContext',
            fields=[
                ...
                ('target3ID', models.CharField(help_text='(max. 1000 characters)', max_length=1000, null=True, verbose_name='Item ID (3)')),
                ('target3Text', models.TextField(blank=True, null=True, verbose_name='Text (3)')),
                ('target3ContextLeft', models.TextField(blank=True, null=True, verbose_name='Target context (3)')),
                ...
                ('documentID', models.CharField(help_text='(max. 200 characters)', max_length=200, verbose_name='Document ID')),
        ...
        migrations.CreateModel(
            name='ContrastiveAssessmentDocumentTask',
            fields=[
                ...
                ('items', models.ManyToManyField(related_name='%(app_label)s_%(class)s_items', related_query_name='%(app_label)s_%(class)ss', to='EvalData.textsegmentwiththreetargetswithcontext', verbose_name='Items')),
        ...
        migrations.CreateModel(
            name='ContrastiveAssessmentDocumentResult',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dateCreated', models.DateTimeField(auto_now_add=True, verbose_name='Date created')),
                ('dateActivated', models.DateTimeField(blank=True, null=True, verbose_name='Date activated')),
                ...
                ('score3', models.PositiveSmallIntegerField(blank=True, help_text='(value in range=[1,100])', null=True, verbose_name='Score (3)')),
                ...
                ('mqm3', models.TextField(default='[]', help_text='MQM JSON string', verbose_name='MQM (3)')),
                ('sourceErrors', models.TextField(blank=True, max_length=2000, null=True, verbose_name='Source errors')),
                ('errors1', models.TextField(blank=True, max_length=2000, null=True, verbose_name='Errors (1)')),
                ('errors2', models.TextField(blank=True, max_length=2000, null=True, verbose_name='Errors (2)')),
                ('errors3', models.TextField(blank=True, max_length=2000, null=True, verbose_name='Errors (3)')),
                ('comment', models.TextField(blank=True, default='', help_text='Annotator comment', verbose_name='Comment')),
                ...
                ('browser_info', models.CharField(blank=True, help_text='(browser type and version when available)', max_length=255, null=True, verbose_name='Browser info')),
                ('activatedBy', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='%(app_label)s_%(class)s_activated_by', related_query_name='%(app_label)s_%(class)ss', to=settings.AUTH_USER_MODEL, verbose_name='Activated by')),
                ('completedBy', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='%(app_label)s_%(class)s_completed_by', related_query_name='%(app_label)s_%(class)ss', to=settings.AUTH_USER_MODEL, verbose_name='Completed by')),
                ('createdBy', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.PROTECT, related_name='%(app_label)s_%(class)s_created_by', related_query_name='%(app_label)s_%(class)ss', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='%(app_label)s_%(class)s_item', related_query_name='%(app_label)s_%(class)ss', to='EvalData.textsegmentwiththreetargetswithcontext', verbose_name='Item')),
                ('modifiedBy', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='%(app_label)s_%(class)s_modified_by', related_query_name='%(app_label)s_%(class)ss', to=settings.AUTH_USER_MODEL, verbose_name='Modified by')),
                ('retiredBy', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='%(app_label)s_%(class)s_retired_by', related_query_name='%(app_label)s_%(class)ss', to=settings.AUTH_USER_MODEL, verbose_name='Retired by')),
                ('task', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='%(app_label)s_%(class)s_task', related_query_name='%(app_label)s_%(class)ss', to='EvalData.contrastiveassessmentdocumenttask', verbose_name='Task')),
            ],
            options={
                'ordering': ['_str_name'],
                'abstract': False,
