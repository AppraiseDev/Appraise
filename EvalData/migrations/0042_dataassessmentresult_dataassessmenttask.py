    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('items', models.ManyToManyField(related_name='evaldata_dataassessmenttask_items', related_query_name='evaldata_dataassessmenttasks', to='EvalData.TextPair', verbose_name='Items')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='evaldata_dataassessmentresult_item', related_query_name='evaldata_dataassessmentresults', to='EvalData.TextPair', verbose_name='Item')),
